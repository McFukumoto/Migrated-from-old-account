...
rdr1 <- rdrobust(Mob1r$Moving13, Mob1r$GDmarginG14, c = 0, fuzzy = NULL, deriv = NULL, p = NULL, q = NULL,
h = NULL, b = NULL, rho = NULL, #covs = KY, 
kernel = "tri", weights = NULL, bwselect = "mserd",
vce = "nn",   cluster = Mob1r$COMMUNE, 
nnmatch = 3, level = 95, scalepar = 100, scaleregul = 1,
...
rd1 <- rdplot(Mob1r$Moved13, Mob1r$GDmarginG14, c = 0, p = 4, nbins = 50, binselect = "esmv",
scale = NULL, kernel = "uni", weights = NULL, h = NULL,
covs = NULL, covs_eval = 0, covs_drop = TRUE,
support = NULL, # subset = (Mob1r$AGEMEN8 =="65"),  
hide = FALSE, ci = NULL, shade = FALSE, title = "Retired: moved in in 2013 (2013 housing census)",
x.label = "Left-Right margin", y.label = "", x.lim = c(-50,50), #y.lim = c(0,0.03),
...
hide = FALSE, ci = NULL, shade = FALSE, title = "Retired under 64: moved in in 2013 (2013 housing census)",
x.label = "Left-Right margin", y.label = "", x.lim = c(-50,50), #y.lim = c(0,0.04),
col.dots = NULL, col.lines = NULL)
...
x.label = NULL, y.label = "", x.lim = c(-50,50), #y.lim = c(0,0.005),
col.dots = NULL, col.lines = NULL)
...
scale = NULL, kernel = "uni", weights = NULL, h = NULL,
covs = NULL, covs_eval = 0, covs_drop = TRUE,
support = NULL, subset = (Mob1r$AGEMEN8 =="55"|Mob1r$AGEMEN8 =="40"|Mob1r$AGEMEN8 =="25"|Mob1r$AGEMEN8 =="20" ),  
hide = FALSE, ci = NULL, shade = FALSE, title = NULL,
x.label = NULL, y.label = "", x.lim = c(-50,50), #y.lim = c(0,0.005),
col.dots = NULL, col.lines = NULL)
...
rd1 <- rdplot(Mob1r$Moved12, Mob1r$GDmarginG14, c = 0, p = 4, nbins = 50, binselect = "esmv",
scale = NULL, kernel = "uni", weights = NULL, h = NULL,
covs = NULL, covs_eval = 0, covs_drop = TRUE,
support = NULL, #subset = (Mob1r$AGEMEN8 =="55"|Mob1r$AGEMEN8 =="40"|Mob1r$AGEMEN8 =="25"|Mob1r$AGEMEN8 =="20" ),  
hide = FALSE, ci = NULL, shade = FALSE, title = NULL,
